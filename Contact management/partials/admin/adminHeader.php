...
<div class="navbar">
  ...
  <a><i class='fas fa-user-alt' style='font-size:32px'> </i> <?php echo $data['username']; ?></a>
</div>
      ...
      <ul>
        <?php 
          ...
          while($data1 = mysqli_fetch_assoc($run1)){
            ?>
            <li ><a class="menu_items" href="../page/viewPage.php?page_id=<?php echo $data1['id'] ?>"><?php echo $data1['menu_name']; ?></a></li>
            <?php
          }
        ?>
      </ul>
