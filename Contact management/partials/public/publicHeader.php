...
<link rel="stylesheet" type="text/css" href="../../public/css/publicHeader.css">

</head>
<body>

<div class="navbar">
  <span id="mainHeading" onclick="location.href='../public_html/index.php'">WIDGET CORP</span>
...
<div class="sidenav">
	...
	<div class="content">
		<ul >
            ...
            ?>
                <li class="pages" onclick="location.href='../public_html/viewPage.php?page_id=<?php echo $data1['id'] ?>';">
